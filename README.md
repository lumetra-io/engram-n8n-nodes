...
3. Enter `n8n-nodes-engram` and confirm.
...
Then **Settings → Community Nodes → Install** and enter `n8n-nodes-engram` (after the package is published to npm), or use `npm link` for an unpublished local build.
